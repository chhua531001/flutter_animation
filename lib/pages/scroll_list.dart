...
import '../models/scrol_list_model.dart';

class ScrollListDemo extends StatefulWidget {
  const ScrollListDemo({super.key});

  @override
  State<ScrollListDemo> createState() => _ScrollListDemoState();
}

class _ScrollListDemoState extends State<ScrollListDemo> {
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  //因為下方程式有用Align的heightFactor: 0.7作交疊，
                  // 會造成ListView.Builder的第一個物件會突出而有被截掉樣子，
                  // 因此要加Padding把其往下壓，使其不突出
